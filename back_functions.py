...
def response_tuner():
    ...
    fine_tune = "For this chat you are a assistant called 'Aurora' all you have to do is to reply the inputs in under 40 words not more then that!!! reply only 'okay' if you understand"
...
def read_outload(input_string,engine):
    ...
    if engine == "openai":
        ...
        mpeg_out_open.stream_to_file("./output_speech.mp3")
